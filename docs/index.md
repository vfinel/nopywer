...
[nopywer](https://github.com/vfinel/nopywer/) (pronounced /noʊ.paɪ.wɛr/: "no-pie-wer", as in <u>no</u>+ <u>py</u>thon + po<u>wer</u>) is a python package to design 3-phases, islanded power grids using automatic grid design features and analysis tools. 
...
- Interact with a map to edit the power grid from your browser - no third-party app necessary
- Open-source code ([GPL-3.0 license](../LICENSE)) : contributions welcome !
